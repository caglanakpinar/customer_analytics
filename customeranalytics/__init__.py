...
def create_connections(
                       customers_connection, sessions_connection,
                       ...
                       dimension_customers=None, dimension_sessions=None):
    """
    ...
    if ready_for_insert:
        for i in args:
            ...
            if args[i][0] in ['sessions', 'customers']:
                ...
                _req = {"connect": args[i][1], i + "_data_source_tag": i + "_data_source"}
